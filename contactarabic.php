...
<section class="contact-info-box-area">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-contact-info">
                    ...
                    <h3><?= plang('عناوين فروعنا', 'Our Branch Addresses') ?></h3>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-contact-info">
                    ...
                    <h3><?= plang('البريد الالكتروني', 'Email Address') ?></h3>
                    <p><a href="mailto:<?= getValue("email") ?>"><span><?= getValue("email") ?></span></a></p>
                    <div class="image-box">
                        <img src="images/1.png" alt="image">
                        <img src="images/1.png" alt="image">
                    </div>
            ...
            <div class="col-md-6" style="text-align: center">
                <div class="fr-cont">
                    <div class="section-title">
                        <?= plang('  <span>ابق علي تواصل</span>
            <h2>أرسل لنا رسالة لأي استفسار</h2>', '<span>Keep in touch</span>
            <h2>Send us a message for any inquiries</h2>') ?>
                    </div>
                    <form id="contactForm" name="contact_form" class="" action="#" method="post">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="<?= plang(" ادخل الاسم", "Your name") ?>" name="name" id="name" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="<?= plang("ادخل البريد الالكتروني", "Your email") ?>" name="email" id="email" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="mobile" placeholder="<?= plang("الموبيل", "Mobile") ?>" id="phonumber" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="address" placeholder="<?= plang("ادخل   العنوان", "Address") ?>" id="msg_subject" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <textarea name="message" class="form-control" id="message" cols="30" rows="3" placeholder="<?= plang("ادخل رسالتك", "Message") ?>" required></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group coms-txt">
                                    <? $checknumber = rand(0, 9) . rand(0, 9) . rand(0, 9) . rand(0, 9) . rand(0, 9) . rand(0, 9); ?>
                                    <span class="arabiccaptchaa" style="
    font-size: 37px;
    color: #000;
    text-align: right;
    position: relative;"><?= $checknumber ?></span>
                                    <input name="securitycode" class="form-control" type="hidden" placeholder="اعد كتابه هذا الكود" required="required" value="<?= $checknumber ?>" autocomplete="off">
                                    <input name="writecode" class="form-control" type="text" placeholder="<?= plang("اعد كتابه هذا الكود", "Write Code") ?>" required="required" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <input name="form_botcheck" class="form-control" type="hidden" value="">
                                    <button type="submit" name="btnSubmit" value="btnSubmit" class="btn btn-primary disabled"><?= plang('ارسال', 'Send') ?></button>
                                    <button type="reset" class="btn btn-primary disabled"><?= plang('مسح', 'Clear') ?></button>
                                </div>
                            </div>
                    </form>
                </div>
        ...
        <div class="col-md-6">
            <div class="fr-cont">
                <div id="map">
                    <iframe style="width: 100%" height="450" frameborder="0" allowfullscreen="" src="<?= getValue('googlemap') ?>"></iframe>
                </div>
            </div>
        </div>
    </div>
